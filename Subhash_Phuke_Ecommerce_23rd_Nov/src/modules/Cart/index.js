...
import OrderForm from '../OrderPlacement'
...
const Cart = () => {
  ...
  // const handleOrderSuccess = (formData) => {
  ...
  //       {/* Render OrderForm component and pass the onSuccess callback */}
  //       <OrderForm onSuccess={handleOrderSuccess} />
  //     </div>
  //   );
  // }

  // // Display the order summary after successful submission
  // if (orderSummary) {
  //   return (
  //     <div className="container mx-auto mt-10">
  ...
  //       </div>
  //       {/* Display other order details from orderSummary */}
  //       <div>
  //         <h2>Order Summary:</h2>
  //         <p>Name: {orderSummary.name}</p>
  //         <p>Email: {orderSummary.email}</p>
  //         <p>Phone Number: {orderSummary.phoneNumber}</p>
  //         <p>Address: {orderSummary.address}</p>
  //         <p>Pin Code: {orderSummary.pinCode}</p>
